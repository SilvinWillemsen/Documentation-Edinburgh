...
We can now identify what terms contribute to the the kinetic energy $\mathfrak{t}$ and potential energy $\mathfrak{v}$. The kinetic energy must be in the form of mass $\times$ velocity squared. The rest will contribute to the potential energy. %by seeing whether they are spatially dependent. Not spatially dependent terms contribute to kinetic energy whereas spatially dependent terms contribute to potential energy. (CHECK IF THIS IS CORRECT) 
